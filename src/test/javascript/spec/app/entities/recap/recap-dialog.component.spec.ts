...
import { RecapDialogComponent } from '../../../../../../main/webapp/app/entities/recap/recap-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Recap Management Dialog Component', () => {
        let comp: RecapDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(RecapDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'recapListModification', content: 'OK'});
