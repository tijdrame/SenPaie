...
import { ExerciceDialogComponent } from '../../../../../../main/webapp/app/entities/exercice/exercice-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Exercice Management Dialog Component', () => {
        let comp: ExerciceDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(ExerciceDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'exerciceListModification', content: 'OK'});
