...
import { MotifDialogComponent } from '../../../../../../main/webapp/app/entities/motif/motif-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Motif Management Dialog Component', () => {
        let comp: MotifDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(MotifDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'motifListModification', content: 'OK'});
