...
public class MotifService {
     ...
     *
     * @param motif the id of the entity
     */
    public void delete(Motif motif) {
        log.debug("Request to delete Motif : {}", motif);
        motif.deleted(true);
        motifRepository.save(motif);
    }

    public Motif findByCode(String code){
        return motifRepository.findByCodeAndDeletedFalse(code);
    }
}
