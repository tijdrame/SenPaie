...
public class ConventionService {
    ...
    public Page<Convention> findAll(Pageable pageable) {
        ...
        return conventionRepository.findByDeletedFalse(pageable);
    }
     ...
     */
    public Convention delete(Convention convention) {
        log.debug("Request to delete Convention : {}", convention);
        return conventionRepository.save(convention.deleted(true));
    }
}
