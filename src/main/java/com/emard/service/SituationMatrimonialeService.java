...
public class SituationMatrimonialeService {
    ...
    public SituationMatrimoniale save(SituationMatrimoniale situationMatrimoniale) {
        ...
        situationMatrimoniale.deleted(false);
     ...
     *
     * @param situationMatrimoniale the id of the entity
     */
    public void delete(SituationMatrimoniale situationMatrimoniale) {
        log.debug("Request to delete SituationMatrimoniale : {}", situationMatrimoniale);
        situationMatrimoniale.deleted(true);
