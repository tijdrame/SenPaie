...
public class AbsenceResource {
    ...
    public ResponseEntity<Absence> updateAbsence(@Valid @RequestBody Absence absence) throws URISyntaxException {
        ...
        Absence result = absenceService.update(absence);
    ...
    /**
     * GET  /search/:collaborateur/:exo : get all the Absence like collaborateur and exo.
     *
     * @param pageable the pagination information
     * @param collaborateur le critére de recherche
