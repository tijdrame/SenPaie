...
export class PiecesService {
    ...
    search(prenom?: string, nom?: string, matricule?:string,deleted?:boolean): Observable<HttpResponse<Pieces[]>>{
        return this.http.get<Pieces[]>(`${this.resourceUrl+"Ter"}/${prenom}/${nom}/${matricule}/${deleted}`, { observe: 'response'})
            .map((res: HttpResponse<Pieces[]>) => this.convertArrayResponse(res));
    }
